# -*- coding: utf-8 -*-
print(r'=======================C:\Users\TAMSystech\anaconda3\envs\ocr2\Lib\site-packages\easyocr\easyocr.py')
    ...
    def __init__(self, lang_list, gpu=True, model_storage_directory=None,
        ...
        if recognizer:
            ...
            if recog_network == 'generation1':
                ...
                print(f'easyocr CustomModel 호출 완료 model : {model}')
                print(f'easyocr CustomModel 호출 완료 num_classes : {num_classes}')
