...
class BidirectionalLSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 x : {x}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 type(x) : {type(x)}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 type(x.size) : {x.size}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 x size : {x.size()[0]}, {x.size()[1]}, {x.size()[2]}')
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 self.rnn(x) 후 x : {x}')
        
        output = self.linear(recurrent) # batch_size x T x output_size

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 None_VGG 클래스 BidirectionalLSTM forward 함수 들어옴 self.linear 후 x : {x}')
...
class Model(nn.Module):
    ...
    def forward(self, x, y):
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 x : {x}')

        # 입력의 크기 및 형태를 확인하기 위한 프린트문 추가
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 입력 데이터 확인: {x.size()}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 입력 데이터 확인 x  size: {x.size()[0]}, {x.size()[1]},{x.size()[2]}, {x.size()[3]}')
        ...
        # 1, 512,3, 46
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 Feature extraction 후 x : {x}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 Feature extraction 후 x  size: {x.size}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 Feature extraction 후 x  size: {x.size()[0]}, {x.size()[1]},{x.size()[2]}, {x.size()[3]}')
        # print(
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 permute 후 x : {x}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 permute 후 x size : {x.size}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 permute 후 x  size: {x.size()[0]}, {x.size()[1]},{x.size()[2]}, {x.size()[3]}')
        
        x = x.view(x.size(0), x.size(1), -1)

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 x.view(x.size(0), x.size(1), -1) 후 x : {x}')
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 x.view(x.size(0), x.size(1), -1) 후 x size : {x.size}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 view 후 x size : {x.size()[0]}, {x.size()[1]}, {x.size()[2]}')

        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 self.SequenceModeling 전달하기 최종 전 1572864 ????? size : {x.size()[0]}, {x.size()[1]}, {x.size()[2]}')
        x = self.SequenceModeling(x)

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 SequenceModeling 후 x : {x}')
        

        # Prediction
        x = self.Prediction(x)

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 Prediction 후 x : {x}')

        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!내가 만든 모델 클래스 forward 함수 들어옴 최종 리턴전 모델 호출시 파이토치에서 내부적으로 이함수를 호출한대 x : {x}')
