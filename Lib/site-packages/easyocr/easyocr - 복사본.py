...
class Reader(object):
    ...
    def __init__(self, lang_list, gpu=True, model_storage_directory=None,
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!ocr2 의 easyOcr user_network_directory 어펜드 완료 : {self.user_network_directory}')
        ...
        if recog_network in ['standard'] + [model for model in recognition_models['gen1']] + [model for model in recognition_models['gen2']]:
            ...
            print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!easyOcr.py  219 model_storage_directory: {self.model_storage_directory}')
        ...
        if detector:
            ...
            print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!user-defined model 임inputs[0] if detector  initDetector 호출 완료 detector_path : {detector_path}')
            # print(
        ...
        if recognizer:
            ...
            print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!easyocr user-defined model 임 get_recognizer 함수 실행후 recog_config : {recog_config}')
            print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!easyocr user-defined model 임 get_recognizer 함수 실행후 self.recognizer : {self.recognizer}')
            print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!easyocr user-defined model 임 get_recognizer 함수 실행후 self.converter : {self.converter}')
