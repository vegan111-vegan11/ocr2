...
def recognizer_predict(model, converter, test_loader, batch_max_length,\
    ...
    # 로그용
    #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! recognition.py recognizer_predict 함수 들어옴 model  :  ')
    ...
    with torch.no_grad():
        for image_tensors in test_loader:
            ...
            # 로그용
            #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recoginition recognizer_predict 함수 image : ')
            #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recoginition recognizer_predict 함수 text_for_pred :  ')
            
            preds = model(image, text_for_pred)
            #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recoginition recognizer_predict 함수 type(preds) : {type(preds)}')


            #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recoginition recognizer_predict 함수 preds :  ')
            #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recoginition recognizer_predict 함수 preds : {preds}')
...
def get_recognizer(recog_network, network_params, character,\
    ...
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 recog_network : {recog_network}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 network_params : {network_params}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 character : {character}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 separator_list : {separator_list}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 dict_list : {dict_list}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 model_path : {model_path}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 device : {device}')
    # print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 quantize : {quantize}')


    converter = CTCLabelConverter(character, separator_list, dict_list)
    num_class = len(converter.character)
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 num_class : {num_class}')
    ...
    if recog_network == 'generation1':
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 model_pkg = importlib.import_module(recog_network) 할때 recog_network : {recog_network}')

        recog_network = "easyocr.model.None_VGG_BiLSTM_CTC"
        recog_network = "custom.models.model"
        recog_network = "easyocr.model.None_VGG_BiLSTM_CTC_custom"
        recog_network = "easyocr.model.None_VGG_BiLSTM_CTC_th"
        #recog_network = "custom.models.model"
        model_pkg = importlib.import_module(recog_network)

        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 내가 만든 모델일때 model_pkg : {model_pkg}')

    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 내가 만든 모델일때 num_class : {num_class}')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 내가 만든 모델일때 network_params : {network_params}')


    model = model_pkg.Model(num_class=num_class, **network_params)

    #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!get_recognizer 함수 들어옴 내가 만든 모델일때 model : {model}')
...
def get_text(character, imgH, imgW, recognizer, converter, image_list,\
    ...
    #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!recognition get text 함수 들어옴 character : {character}')
